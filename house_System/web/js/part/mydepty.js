...
function getAll(current,flag) {
	...
	if(flag==0)
		{
		  $(".tablelist").append("<thead><tr align='center'><th width='10%' align='center'>编号</th><th width='25%' align='center'>部门名称</th><th width='35%' align='center'>部门备注</th><th width='15%' align='center'>修改</th><th width='15%'>运营部门</th></tr></thead>");
		}
	else
		{
		   $(".tablelist").append("<thead><tr align='center'><th width='10%' align='center'>编号</th><th width='25%' align='center'>部门名称</th><th width='35%' align='center'>部门备注</th><th width='15%' align='center'>恢复部门</th></tr></thead>");
		}
	
    $.ajax({
    	url:'http://localhost:8081/house_System_Web_exploded/dept',
    	dataType:'json',
    			...
    			if(xx.pid!=null)
    				{
    				    	    ...
    				    	    srt+='<td><a href="#" class="backdel">恢复部门</a></td></tr>';
